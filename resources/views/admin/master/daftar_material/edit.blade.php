...
@section('content')
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.master.daftar_material.update',$material->id_part_num) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="material_name" id="material_name"
                        ...
                        placeholder="Material Name" value="{{old('part_num',$material->material_name)}}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="uom" id="uom"
                        ...
                        placeholder="UoM" value="{{old('part_num',$material->uom)}}">
